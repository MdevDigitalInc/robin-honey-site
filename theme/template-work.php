...
<main class="rhd-main">
  ...
  <div class="rhd-container">
     <div class="rhd-row flex flex-row flex-wrap flex-hor-center">
      <div class="rhd-work-heading"><h1><?php echo stripslashes($current->title);?></h1></div>
     ...
     <img src="<?php echo bloginfo('template_url'); ?><?php echo $current->heroImage; ?>" alt="<?php echo stripslashes($current->heroAlt); ?>">
  </div>
  </section>
  <section class="rhd-container rhd-work-example-info">
    ...
    <aside class="rhd-aside brand-description">
      <h4>Description</h4>
      <p><?php echo stripslashes($current->caseDescription);?></p>
    ...
    <div class="rhd-work-example-logo">
      <img src="<?php echo bloginfo('template_url'); ?><?php echo $current->clientLogo;?>" alt="<?php echo stripslashes($current->clientAlt);?>">
    </div>
    <div class="rhd-content-right brand-description">
      <p><?php echo stripslashes($current->projSummary);?></p>
    </div>
   </div>
  </section>
  <section class="rhd-section-light-grey rhd-testimonial">
    <div class="rhd-container">
      <br>
      <br>
      <p class="u-italic u-text-center"><?php echo stripslashes($current->testimonial);?></p><!--“”-->
      <br>
