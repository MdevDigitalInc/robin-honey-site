...
<main class="rhd-main">
  ...
  <div class="rhd-container">
     <div class="rhd-row flex flex-row flex-wrap flex-hor-center">
      <div class="rhd-work-heading"><h1>maxliving</h1></div>
      <div class="rhd-view-more-work"><a href="<?php echo home_url('/'); ?>cowbell-brewing-co" title=""><i class="fas fa-chevron-left"></i></a> <span>view more work</span>  <a href="<?php echo home_url('/'); ?>navigreat-fine-foods/" title=""><i class="fas fa-chevron-right"></i></a></div>
     </div>
     <img src="<?php echo bloginfo('template_url'); ?>/img/maxliving-hero.png" alt="">
  </div>
  </section>
  <section class="rhd-container rhd-work-example-info">
    ...
    <aside class="rhd-aside brand-description">
      ...
      <p><a href="https://www.maxliving.com" title="" target="_blank">maxliving.com</a></p>
       <p class="u-italic small small-note">NOTE: Creative work was executed by <a href="https://thearcane.com/" title="" target="_blank">Arcane.</a></p>
    </aside>
    <div class="rhd-work-example-logo">
      <img src="<?php echo bloginfo('template_url'); ?>/img/logo-maxliving.png" alt="">
    </div>
