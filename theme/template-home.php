...
<main class="rhd-main">
  ...
  <section class="rhd-section-blue">
    ...
    <div class="rhd-container">
      ...
      <h3>A brand is a story that people can connect to. Robin works fluidly between words and images to create new ideas, built solidly on business objectives.</h3>
