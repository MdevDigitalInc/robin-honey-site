...
<main class="rhd-main">
    ...
    <?php if (have_posts()): while (have_posts()) : the_post(); ?>
      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="rhd-row flex flex-row flex-wrap flex-hor-center rhd-section-light-grey">
            ...
            <div class="rhd-main-photo">photo</div> 
  ...
  <section class="rhd-container">
    ...
    <aside class="rhd-aside">
      ...
      <ul>
        <li>info@robinhoney.com</li>
        <li>LinkedIn – Robin Honey</li>
        <li>Twitter - @honeylondon Instagram – Robin Honey </li>
        <li>Pinterest – Robin Honey</li>
      </ul>
    ...
    <div class="rhd-content-right">
      ...
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas tristique diam volutpat nulla lacinia vestibulum.</p>
      ...
      <p>Robin’s speaking engagements focus on the process of branding with case studies tailored to the audience along with practical advice.</p>
