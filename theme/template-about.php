...
<main class="rhd-main">
  <section class="rhd-about-robin">
    <div class="rhd-container rhd-about-container">
      ...
      <a href="<?php echo home_url('/'); ?>cowbell-brewing-co/" class="rhd-base-btn rhd-main-btn" title="">View Work</a>
      </div>
      </div>
      <div class="rhd-bio">
      <h2>Bio</h2>
  ...
  <section class="rhd-section-light-grey about-info">
    <div class="rhd-container">
      <div class="rhd-row flex flex-row flex-wrap">
        ...
        <h2>writing</h2>
        <p><span class="text-light">Check out Robin’s articles about branding on LinkedIn.</span></p>
