    ...
    <div class="rhd-container">
      ...
      <div class="rhd-row flex flex-row flex-wrap flex-hor-center ">
        <aside class="rhd-aside">
          ...
          <ul class="rhd-list">
            <li><a href="">info@robinhoney.com</a></li>
            <li><a href="">LinkedIn – Robin Honey</a></li>
            <li><a href="">Twitter - @honeylondon </a></li>
            <li><a href="">Instagram – Robin Honey </a></li>
            <li><a href="">Pinterest – Robin Honey</a></li>
          </ul>
